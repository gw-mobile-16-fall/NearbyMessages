...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    /**
     * The UUID is added to the publishe message to avoid it being undelivered due to de-duplication.
     */
    ...
    /**
     * The object used to broadcast messages to nearby devices.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Build the message that is going to be published. This contains the message and a UUID.
    ...
    /**
     * Builds {@link GoogleApiClient}, enabling automatic lifecycle management
     */
